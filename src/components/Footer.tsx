    ...
    <footer className="bg-sand-900 text-sand-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <Link to="/" className="flex items-center gap-2 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-forest-500 to-forest-600 rounded-xl flex items-center justify-center shadow-lg">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C8.5 2 6.5 4.5 6.5 7c0 1.5.5 2.5 1.5 3.5-2 1-3.5 3-3.5 5.5 0 3 2.5 6 7.5 6s7.5-3 7.5-6c0-2.5-1.5-4.5-3.5-5.5 1-.5 1.5-2 1.5-3.5 0-2.5-2-5-5.5-5zM9 6.5c0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5-.7 1.5-1.5 1.5S9 7.3 9 6.5zm3 1.5c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5-1.5-.7-1.5-1.5.7-1.5 1.5-1.5z"/>
                </svg>
              </div>
              <span className="font-heading text-xl font-bold text-white">
                Pet<span className="text-sunset-400">Venture</span>
              </span>
            </Link>
            <p className="text-sand-400 leading-relaxed mb-6 max-w-sm">
              Giving Bay Area pups the adventures they deserve since 2020. From beaches to mountains, 
              we make every day an unforgettable experience for your furry best friend.
            </p>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-sand-800 rounded-lg flex items-center justify-center text-sand-400 hover:bg-forest-600 hover:text-white transition-all"
          ...
          {/* Adventures */}
          <div>
            <h3 className="font-heading font-semibold text-white mb-4">Adventures</h3>
            <ul className="space-y-3">
              {footerLinks.adventures.map((link) => (
                <li key={link.name}>
                  <Link to={link.href} className="text-sand-400 hover:text-sunset-400 transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sand-500 text-sm">
              © {currentYear} PetVenture. All rights reserved. Made with 🐾 in San Francisco.
            </p>
            <div className="flex gap-6 text-sm">
              <Link to="/privacy-policy" className="text-sand-500 hover:text-sand-300 transition-colors">
                Privacy Policy
              </Link>
              <Link to="/terms-of-service" className="text-sand-500 hover:text-sand-300 transition-colors">
                Terms of Service
              </Link>
              <Link to="/cookie-policy" className="text-sand-500 hover:text-sand-300 transition-colors">
                Cookie Policy
              </Link>
            </div>
          </div>
