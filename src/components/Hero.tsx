  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.pexels.com/photos/1906153/pexels-photo-1906153.jpeg?auto=compress&cs=tinysrgb&w=1920"
          alt="Happy golden retriever on a mountain trail"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-2xl">
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 leading-relaxed">
            From Yosemite trails to Pacific beaches, we take your furry best friend on unforgettable 
            adventures while you're at work or away. Because every dog deserves a vacation too.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <a
              href="#experiences"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-sunset-500 to-sunset-600 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-xl shadow-sunset-500/30 hover:shadow-sunset-500/50 hover:scale-105 transition-all"
            >
              Explore Adventures
          ...
          <div className="flex flex-wrap items-center gap-8">
            <div className="flex items-center gap-2">
              <div className="flex -space-x-3">
                ...
                <div className="w-10 h-10 rounded-full border-2 border-white bg-forest-500 flex items-center justify-center text-white text-xs font-bold">
                  +99
                </div>
              </div>
              <div className="text-white/80 text-sm">
                <span className="font-semibold text-white">500+</span> Happy Pups
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex text-sunset-400">
                {[...Array(5)].map((_, i) => (
